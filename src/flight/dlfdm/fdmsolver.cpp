...
namespace dlfdm
{
    ...
    void FDMSolver::update(const ControlInputs &controls)
    {
        ...
        while (aircraft_state_.psi > 3.14159f)
            aircraft_state_.psi -= 6.28318f;
        while (aircraft_state_.psi < -3.14159f)
            aircraft_state_.psi += 6.28318f;
    }
