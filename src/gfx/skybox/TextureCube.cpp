...
namespace gfx
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    //  Carga desde 6 archivos independientes
    ////////////////////////////////////////////////////////////////////////////
    ...
    bool TextureCube::loadCubeFaces(const util::CubeFaces &faces)
    {
        ...
        // Configurar parámetros de filtrado / clamp una única vez.
        setupParameters();
        ...
        // Subir los datos raw de cada cara.
        for (int i = 0; i < 6; ++i)
        {
            ...
            // Se usa GL_RGBA8 para garantizar compatibilidad amplia en GPUs antiguas.
            glTexImage2D(
