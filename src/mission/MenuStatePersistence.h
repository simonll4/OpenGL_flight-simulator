...
namespace mission
{
    ...
    struct MenuState
    {
        std::string lastMissionId = ""; ///< ID textual de la misión resaltada
        int lastMissionIndex = 0;       ///< Posición dentro del listado (fallback cuando no existe el ID)
    };
    ...
    public:
        /**
         * @brief Guardar el estado del menú en un JSON plano (campos id/index).
