...
void MissionMenu::renderMissionList() {
    ...
    for (size_t i = 0; i < missionCount; ++i) {
        ...
        glm::vec4 textColor = isSelected ?
            glm::vec4(1.0f, 1.0f, 1.0f, 1.0f) :
            glm::vec4(0.75f, 0.8f, 0.9f, 1.0f);
        ...
        for (int d = 0; d < 5; ++d) {
            glm::vec4 starColor = (d < mission->difficulty) ?
                glm::vec4(1.0f, 0.7f, 0.0f, 1.0f) :
                glm::vec4(0.2f, 0.2f, 0.3f, 0.5f);
        ...
        if (itemY > listY + panelHeight - 20) break;
    }
}
